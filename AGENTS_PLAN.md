...
### Mod 1.2.9 - Live App Usage: group by app name
- Merged PID entries by app name before slicing to top 8
- Fixed duplicate app rows (e.g. Chrome with multiple connections)
